...
export async function createOrder() {
  try {
    ...
    // Note: Create a transaction to create order and order items in database
...
export async function getMyOrders({
  ...
  // Note: How to pass orderBy, take and skip in Prisma.
  ...
  // Note: How to get count of records in Prisma
...
export async function getOrderSummary() {
  ...
  // Note: Use aggregate function in Prisma
  const totalSales = await prisma.order.aggregate({
    _sum: { totalPrice: true },
  });

  // Get monthly sales
  // Note: Use Native Raw SQL query in Prisma
